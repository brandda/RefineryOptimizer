...
FileList=[]
Tablename_Stg=GV.TDLogVar["DATABASE"] + ".DB250092_RO_LAB_COMP_GROUP_STG"
Tablename_Core=GV.TDLogVar["DATABASE"] + ".DB250092_RO_LAB_COMP_GROUP"

commit=10000
print("Reading Input Data")
input=GV.TDLogVar["DATADIR"]
datalist=GV.ReadInputData(input,"Lab_Comp_Group.csv",1,",",commit)[0]            
rowcount=GV.ReadInputData(input,"Lab_Comp_Group.csv",1,",",commit)[1]            
if len(datalist)==0:
...
with con.cursor() as cur:
    ...
    try:
        sStageCreate="CREATE MULTISET TABLE " + Tablename_Stg + ", \
            ...
            Component_Group VARCHAR(100) CHARACTER SET LATIN NOT CASESPECIFIC NOT NULL,\
            Component_ID VARCHAR(20) CHARACTER SET LATIN NOT CASESPECIFIC NOT NULL) \
        PRIMARY INDEX (Ref_Location,Component_Group,Component_ID)"
...
#        print("       Null Update completed")
    ...
    try:
        ...
        cur.execute(sTrunc)
        sReload="INSERT INTO " + Tablename_Core + " SELECT Ref_Location,Component_Group,Component_ID,\
