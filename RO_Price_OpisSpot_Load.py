...
FileList=[]
Tablename_Stg=GV.TDLogVar["DATABASE"] + ".DB250092_RO_PRICE_OPISSPOT_STG"
Tablename_Core=GV.TDLogVar["DATABASE"] + ".DB250092_RO_PRICE"

commit=10000
print("Reading Input Data")
input=GV.TDLogVar["DATADIR"] + "/pricing/opis"
datalist=GV.ReadInputData(input,"opisspotsdatafiles.csv",0,",",commit)[0]            
rowcount=GV.ReadInputData(input,"opisspotsdatafiles.csv",0,",",commit)[1]            
if len(datalist)==0:
...
with con.cursor() as cur:
    ...
    try:
        sMerge="MERGE INTO " + Tablename_Core + " CORE USING (\
            ...
            Price_Avg,Price_Close,NULL as Price_Index,NULL as Price_Volume,\
