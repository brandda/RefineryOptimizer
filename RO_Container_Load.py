...
FileList=[]
Tablename_Stg=GV.TDLogVar["DATABASE"] + ".DB250092_RO_CONTAINER_STG"
Tablename_Core=GV.TDLogVar["DATABASE"] + ".DB250092_RO_CONTAINER"

commit=10000
print("Reading Input Data")
input=GV.TDLogVar["DATADIR"]
datalist=GV.ReadInputData(input,"Container.csv",1,",",commit)[0]            
rowcount=GV.ReadInputData(input,"Container.csv",1,",",commit)[1]            
if len(datalist)==0:
...
with con.cursor() as cur:
    ...
    try:
        sStageCreate="CREATE MULTISET TABLE " + Tablename_Stg + ", \
            ...
            Container_ID VARCHAR(20) CHARACTER SET LATIN NOT CASESPECIFIC NOT NULL,\
            Container_Type VARCHAR(20),\
            Container_Desc VARCHAR(100),\
            Min_Op_Qty VARCHAR(20),\
            Max_Op_Qty VARCHAR(20),\
            Min_Op_Hgt VARCHAR(20),\
            Max_Op_Hgt VARCHAR(20),\
            Units VARCHAR(20)) \
        PRIMARY INDEX (Ref_Location,Container_ID)"
    ...
    NullColumnList=["Container_Type","Container_Desc","Min_Op_Qty","Max_Op_Qty","Min_Op_Hgt"\
                   ,"Max_Op_Hgt","Units"]
    ...
    try:
        ...
        cur.execute(sTrunc)
        sReload="INSERT INTO " + Tablename_Core + " SELECT Ref_Location,Container_ID,Container_Type,\
            Container_Desc,Min_Op_Qty,Max_Op_Qty,Min_Op_Hgt,Max_Op_Hgt,Units,\
